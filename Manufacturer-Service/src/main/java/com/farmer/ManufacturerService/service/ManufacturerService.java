...
/*
    ...
    public Manufacturer updateManufacturer(Manufacturer manufacturer) {
        ...
        Optional<Manufacturer> updateManufacturer=manufacturerRepository.findById(manufacturer.getManufacturerId());
        if(updateManufacturer.isPresent()){
            ...
            manu.setPassword(updateManufacturer.get().getPassword());
            manu.setRoles(updateManufacturer.get().getRoles());
