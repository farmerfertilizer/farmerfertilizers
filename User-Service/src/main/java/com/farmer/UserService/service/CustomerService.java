      ...
      public Customer saveCustomer(Customer cust) throws EmailidAlreadyExistsException{
        ...
        public Customer updateCustomer(Customer customer) throws  Exception{
            ...
            if(updateCustomer.isPresent()){
                customers.setCustomerId(updateCustomer.get().getCustomerId());        customers.setFirstName(customer.getFirstName());        customers.setLastName(customer.getLastName());        customers.setEmail(updateCustomer.get().getEmail());        customers.setPhoneNumber(customer.getPhoneNumber());        customers.setUserName(updateCustomer.get().getUserName());        customers.setPassword(updateCustomer.get().getPassword());        customers.setRole(updateCustomer.get().getRole());
            }else{
                return new Customer();
            }
