 ...
 */
    ...
    @PutMapping("/crops/update/{manufacterId}")
    @PreAuthorize("hasAuthority('ADMIN')")
    public ResponseEntity<Crops> updateCrops(@PathVariable("manufacterId") int manufacterId,@RequestBody Crops crops){
        log.info(manufacturerController.updateCrops(manufacterId,crops).toString());
        return manufacturerController.updateCrops(manufacterId,crops);
    }
    ...
    @PutMapping("/fertilizer/update/{manufacturerId}")
    @PreAuthorize("hasAuthority('ADMIN')")
    public ResponseEntity<Fertilizer> updateFertilizer(@PathVariable("manufacterId") int manufacturerId,@RequestBody Fertilizer fertilizer){
        log.info(manufacturerController.updateFertilizers(manufacturerId,fertilizer).toString());
        return manufacturerController.updateFertilizers(manufacturerId,fertilizer);
    }
