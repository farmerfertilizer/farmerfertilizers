...
public interface ManufacturerController {
    ...
    @PutMapping("/fertilizer/update/{manufacterId}")
    public ResponseEntity<Fertilizer> updateFertilizers(@PathVariable("manufacterId") int manufacterId,@RequestBody Fertilizer fertilizer);
